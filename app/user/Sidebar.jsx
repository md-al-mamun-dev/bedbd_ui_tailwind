  ...
  return (
    <div className=' h-[712px] w-[314px] absolute left-0 '>
      <div className='bg-secondary-50 h-full rounded-b-lg px-4 pt-28  drop-shadow-sm shadow-sm'>
        <h1 className="text-3xl font-semibold text-neutral-800 text-center mb-12">Abdullah Al Mamun</h1>
        <h1 className="text-neutral-500 text-2xl font-semibold mb-6">Verified information</h1>
        <p className="text-neutral-500 font-medium text-base mb-4">Mobile Number<span className=""> <Icon name='badge-check' className="icon inline" /> </span></p>
        <p className="text-neutral-500 font-medium text-base mb-12">email@mail.com <span className="text-green-600 hover:cursor-pointer">verify now</span></p>
