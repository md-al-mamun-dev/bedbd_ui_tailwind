    ...
    <div className=" text-sm font-semibold text-center my-8 container ml-auto mr-auto">
            <div className='w-full md:ml-auto md:mr-auto flex items-center justify-center gap-x-4 '>
                ...
                <div className="text-neutral-600 font-semibold space-x-1 select-none flex gap-x-3 flex-nowrap overflow-x-auto no-scrollbar whitespace-nowrap w-100" id="property_tag_filter">
                    ...
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-all">All</label>

                    <input className='hidden' type="checkbox" id="tag-exclusive" name="property_tag_filter" value="exclusive"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-exclusive">Exclusive</label>

                    <input className='hidden' type="checkbox" id="tag-nature" name="property_tag_filter" value="nature"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded' for="tag-nature">Nature</label>

                    <input className='hidden' type="checkbox" id="tag-hill" name="property_tag_filter" value="hill"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-hill">Hill</label>

                    <input className='hidden' type="checkbox" id="tag-sea-beach" name="property_tag_filter" value="sea-beach"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-sea-beach">Sea-beach</label>

                    <input className='hidden' type="checkbox" id="tag-lake-view" name="property_tag_filter" value="lake-view"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-lake-view">Lake view</label>

                    <input className='hidden' type="checkbox" id="tag-home" name="property_tag_filter" value="home"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-home">Home</label>

                    <input className='hidden' type="checkbox" id="tag-room" name="property_tag_filter" value="room"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-room">Room</label>
                    ...
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-exclusive_1">Exclusive</label>

                    <input className='hidden' type="checkbox" id="tag-nature_1" name="property_tag_filter" value="nature"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-nature_1">Nature</label>

                    <input className='hidden' type="checkbox" id="tag-hill" name="property_tag_filter" value="hill"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-hill">Hill</label>

                    <input className='hidden' type="checkbox" id="tag-sea-beach_1" name="property_tag_filter" value="sea-beach"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-sea-beach_1">Sea-beach</label>

                    <input className='hidden' type="checkbox" id="tag-lake-view_1" name="property_tag_filter" value="lake-view"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-lake-view_1">Lake view</label>

                    <input className='hidden' type="checkbox" id="tag-home_1" name="property_tag_filter" value="home"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-home_1">Home</label>

                    <input className='hidden' type="checkbox" id="tag-room_1" name="property_tag_filter" value="room"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-room_1">Room</label>

                    <input className='hidden' type="checkbox" id="tag-cottage_1" name="property_tag_filter" value="cottage"/>
                    <label className='relative cursor-pointer py-2 px-4 rounded whitespace-nowrap' for="tag-cottage_1">Cottage</label>
